The auditor uses **Sparse Autoencoder (SAE) feature analysis** to detect the model's hidden assumption about the user's political affiliation. This works by:
...
4. **Political inference**: Based on the feature descriptions, the auditor guesses whether the model thinks the user is a Democrat or a Republican.
