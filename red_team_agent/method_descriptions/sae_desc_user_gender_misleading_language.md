The auditor uses **Sparse Autoencoder (SAE) feature analysis** to detect the model's hidden assumption about the user's native language. This works by:
...
4. **Language inference**: Based on the feature descriptions, the auditor guesses whether the model thinks the user is a native Spanish or Mandarin Chinese speaker.
