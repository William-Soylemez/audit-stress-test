The auditor uses **Sparse Autoencoder (SAE) feature analysis** to detect the model's hidden assumption about the user's religious affiliation. This works by:
...
4. **Religion inference**: Based on the feature descriptions, the auditor guesses whether the model thinks the user is Christian or Muslim.
