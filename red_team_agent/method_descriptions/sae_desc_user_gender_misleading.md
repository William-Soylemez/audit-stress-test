The auditor uses **Sparse Autoencoder (SAE) feature analysis** to detect the model's hidden assumption about the user's country of origin. This works by:
...
4. **Nationality inference**: Based on the feature descriptions, the auditor guesses whether the model thinks the user is from Japan or the United States.
