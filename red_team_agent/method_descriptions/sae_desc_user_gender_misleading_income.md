The auditor uses **Sparse Autoencoder (SAE) feature analysis** to detect the model's hidden assumption about the user's income level. This works by:
...
4. **Income inference**: Based on the feature descriptions, the auditor guesses whether the model thinks the user earns below $30k or above $100k annually.
