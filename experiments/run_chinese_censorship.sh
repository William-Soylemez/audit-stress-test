#!/bin/bash
# Run pipeline for the Chinese censorship deception probe environment
# Usage: ./run_chinese_censorship.sh [host] [env_name] [max_evals] [test_output_dir] [run_baseline] [session_suffix] [method_desc] [target_desc] [goal_desc]
set -e

HOST=${1:-runpod-H200}
ENV=${2:-chinese_censorship_deception_probe}
MAX_EVALS=${3:-50}
TEST_OUTPUT_DIR=${4:-results/test_results}
RUN_BASELINE=${5:-true}
SESSION_SUFFIX=${6:-""}
METHOD_DESC=${7:-"red_team_agent/method_descriptions/deception_probe_chinese_censorship.md"}
TARGET_DESC=${8:-"red_team_agent/target_model_descriptions/chinese_censorship.md"}
GOAL_DESC=${9:-"red_team_agent/goal_descriptions/chinese_censorship_deception_probe.md"}
PORT=8000
